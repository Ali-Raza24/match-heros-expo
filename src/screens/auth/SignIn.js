...
import { View, StyleSheet, ScrollView,SafeAreaView, Image,Dimensions, TouchableOpacity, StatusBar, Alert, AsyncStorage } from "react-native";
      ...
      <SafeAreaView style={{flex:1,height:Dimensions.get("window").height}}>
        ...
        <View style={{ display: "flex", flex: 0.7, alignItems: "center", }}>
          <View style={{ width: "80%", marginTop: 12 }}>
            ...
            <TextInputField placeHolder={"Email"} placeHolderColor={"#ffffff"} inputFieldBackColor= {"#1E2646"} inputColor='#ffffff' borderBottomColor={'#1E2646'}
            ref={input => {
           ...
           onSubmitEditing={() => {
            ...
            placeHolder={"Password"} placeHolderColor={"#ffffff"} inputFieldBackColor= {"#1E2646"} inputColor='#ffffff' borderBottomColor={'#1E2646'}
            ref={input => {
            ...
            />
             <View style={{position:'absolute',zIndex:999,height:22,width:22,bottom:16,right:6,}}>
             <ShowAndHide style={{ marginRight: 10 }} onPress={this.showOrHidePass} hide={this.state.passHidden} />
</View> 
            </View>
            {this.state.errors.password &&
              <Text style={{color:'red'}}>
                {this.state.errors.password ? this.state.errors.password : this.state.errors.serverErrors ? this.state.errors.serverErrors : ""}
              </Text>
            }
            ...
            height={45} loading={this.state.buttonLoading}
            color={["#0B8140", "#0A5129"]}
            />
            ...
            {this.props.loginFail &&
             ...
             <TouchableOpacity style={{ marginTop: 20 }} activeOpacity={0.6} onPress={() => this.props.navigation.navigate("ForgotPasswordEmail")}>
                 <Text
                  style={{
                    fontSize: 14,
                    lineHeight: 16,
