        ...
        >
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    ...
                    <View style={{width:'80%',marginBottom:32,justifyContent:'center',alignItems:'center'}}>
                   <Image source={require("../../../assets/inviteSuccess.png")} style={{height:87,width:87,resizeMode:'contain'}}/>
                   <Text style={{lineHeight:29,fontSize:18}}>Hero successfully invited</Text>
